...
function Home() {
    ...
    return(
        ...
        <div className="text">
        <h2 className="home-h2">Your one-stop shop for a full house remodelling</h2>
...
<button className="about-btn" onClick={() => navigate('/contact')}>Get Your Free Estimate Today</button>
            ...
            <hr></hr>
            <h3 className="home-h3">Our team handles everything, from initial design to the final finishes for your kitchen.</h3>
